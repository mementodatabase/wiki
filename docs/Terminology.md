...
### Databases
Memento is a database product, and a user's Memento libraries, together with associated files &mdash; including photos, barcodes, and so on &mdash; constitute the user's overall Memento database. However, this is NOT a carefully defined term. One could consider the set of libraries within a Group to be a database; or perhaps each set of libraries that are linked together to formulate a solution, aggregated or otherwise. So, *database* remains a general term.
