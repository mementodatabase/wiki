...
## Script
**Script itself** — JavaScript script. The context of the script is the [**Entry object**](../scripting/Triggers.md#Object_Entry). The value returned is the last value assigned or expressed.
...
## Fields of an entry
Function [***field("fieldName")***](../scripting/Triggers.md#field(name)) is used to get access to the values of entry fields.
