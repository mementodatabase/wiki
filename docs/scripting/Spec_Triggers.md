...
**Phase of an Event** — : One of a predefined set of moments during entry processing for each Event type during which the user can intervene via a trigger script. See [the table of events and phases below](#Events & Phases).
...
| **Event type** | **Phase** | **[Execution mode](#Mode of script execution)** |
| --- | --- | --- |
| | **[Opening a library](#Opening a library)** | **Opening the library** | synchronous |
| **[Creating an entry](#Creating an entry)** | **Opening an Entry Edit card** | synchronous |
| **[Creating an entry](#Creating an entry)** | **Before saving the entry** | synchronous |
| **[Creating an entry](#Creating an entry)** | **After saving the entry** | asynchronous |
| **[Updating an entry](#Updating an entry)** | **Opening an Entry Edit card** | synchronous |
| **[Updating an entry](#Updating an entry)** | **Before saving the entry** | synchronous |
| **[Updating an entry](#Updating an entry)** | **After saving the entry** | asynchronous |
| **[Linking an entry](#Linking an entry)** | **Before saving the entry** | synchronous |
| **[Linking an entry](#Linking an entry)** | **After saving the entry** | asynchronous |
| **[Unlinking an entry](#Unlinking an entry)** | **Before saving the entry** | synchronous |
| **[Unlinking an entry](#Unlinking an entry)** | **After saving the entry** | asynchronous |
| **[Deleting an entry](#Deleting an entry)** | **Before deleting the entry** | synchronous |
| **[Deleting an entry](#Deleting an entry)** | **After deleting the entry** | asynchronous |
| **[Opening an Entry View card](#Opening an Entry View card)** | **Before window display** | synchronous |
| **[Opening an Entry View card](#Opening an Entry View card)** | **After window display** | asynchronous |
| **[Adding an entry to Favorites](#Adding an entry to Favorites)** | **Before the operation** | synchronous |
| **[Adding an entry to Favorites](#Adding an entry to Favorites)** | **After the operation** | asynchronous |
| **[Removing an entry from Favorites](#Removing an entry from Favorites)** | **Before the operation** | synchronous |
| **[Removing an entry from Favorites](#Removing an entry from Favorites)** | **After the operation** | asynchronous |
...
Trigger scripts are in the JavaScript language. See ***[Links to JavaScript documentation](#JavaScript links)*** below.
...
**Permissions** — Certain functions require special permissions; read ***[above](#Security)*** about that. One such function is *libByName()*. Others include the file access and HTTP functions.
...
## See Also
**[Memento JavaScript Library](Memento_JavaScript_Library.md)** — Memento JavaScript functions & objects

**[Trigger Examples](Trigger_Examples.md)** — Examples of trigger scripts for common needs
**[How** — Write scripts in JavaScript for Memento](How**_—_Write_scripts_in_JavaScript_for_Memento.md): Guidelines for writing JavaScript scripts for Memento
