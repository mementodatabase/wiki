...
## Script
**Script itself** — JavaScript script. The context of the script is the [**Entry object**](Triggers.md#Object_Entry). The value returned is the last value assigned or expressed.
...
## Fields of an entry
Function [***field("fieldName")***](Triggers.md#field(name)) is used to get access to the values of entry fields.
