...
**Result** — [***Entry*** object](#Object entry) &mdash; the new entry in the library
...
See **[Examples of trigger use](Tips:Examples_of_trigger_use.md#Libraries_examples)**.
...
**Result** — : [***File*** object](Tips:Examples_of_trigger_use.md#Object_File)
...
### Files examples
See **[Tips:Examples of trigger use#Files examples](Tips:Examples_of_trigger_use.md#Files_examples)**.
...
### Http examples
See [*Http* examples](Tips:Examples_of_trigger_use.md#Http_examples).
...
### System examples
See [***System*** examples](Tips:Examples_of_trigger_use.md#System_examples).
...
See [Examples of *built-in* object use](Tips:Examples_of_trigger_use.md#Examples_of_built-in_object_use).
...
**Data sources** — [Memento *Data Sources*](Spec:Data_Sources.md)
**Examples of trigger use** — [Examples of trigger use](Spec:Examples_of_trigger_use.md)
**Tips for using JavaScript in Memento** — [Tips for using JavaScript in Memento](Tips:Using_JavaScript_in_Memento.md)
