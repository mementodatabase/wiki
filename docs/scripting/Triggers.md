...
| **Creating an entry** | Before saving the entry | synchronous |
| **Creating an entry** | After saving the entry | asynchronous |
| **Updating an entry** | Opening an Entry Edit card | synchronous |
| **Updating an entry** | Before saving the entry | synchronous |
| **Updating an entry** | After saving the entry | asynchronous |
| **Linking an entry** | Before saving the entry | synchronous |
| **Linking an entry** | After saving the entry | asynchronous |
| **Unlinking an entry** | Before saving the entry | synchronous |
| **Unlinking an entry** | After saving the entry | asynchronous |
| **Deleting an entry** | Before deleting the entry | synchronous |
| **Deleting an entry** | After deleting the entry | asynchronous |
| **Opening an Entry View card** | Before window display | synchronous |
| **Opening an Entry View card** | After window display | asynchronous |
| **Adding an entry to Favorites** | Before the operation | synchronous |
| **Adding an entry to Favorites** | After the operation | asynchronous |
| **Removing an entry from Favorites** | Before the operation | synchronous |
| **Removing an entry from Favorites** | After the operation | asynchronous |
