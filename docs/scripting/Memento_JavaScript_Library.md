---
title: "Memento JavaScript Library"
---
...
**Result** — [***Entry*** object](#Object Entry) &mdash; the current entry
...
**Result** — [***DefaultEntry*** object](#Object DefaultEntry)
...
**Result** — [***Library*** object](#Object Library) &mdash; the current library
...
**Result** — [***Library*** object](#Object Library) &mdash; the library identified by the argument *name*, if found. Otherwise *null*.

#### libById(id)
Find the library by id. Permission to use the library is required, based on security settings. *Added in MDB 5.5*

**Argument** — The ID of the library to find

**Result** — [***Library*** object](#Object Library) &mdash; the library identified by the argument *id*, if found. Otherwise *null*.
...
**Argument**
**values** — [Object containing the field values as its properties
****Result**** — :: [***Entry*** object](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object])(#Object entry) &mdash; the new entry to create in the library
...
****Result**** — ::If no entries are present, then null
Otherwise, the **Entry** object

##### firstEntry()
Get the oldest entry created in the library
****Result**** — ::If no entries are present, then null
Otherwise, the [**Entry** object](#Object Entry)
...
**id** — The library identifier; *Added in MDB 5.5*
...
See **[Trigger Examples#Libraries examples](Trigger_Examples.md#Libraries_examples)**.
...
**Result** — : [***File*** object](#Object File)
...
### Files examples
See **[Trigger Examples#Files examples](Trigger_Examples.md#Files_examples)**.

---

## SQL
Memento Database provides an interface for executing SELECT SQL queries, accessible via the sql() function. By using SQL functions, you can perform complex calculations, aggregate data, and transform results directly within the app, enabling advanced data analysis and customized data presentation.
Queries are executed using SQLite, so SQLite syntax should be used. For detailed information on SQLite syntax, please refer to the [**SQLite documentation**](https://www.sqlite.org/lang.html)

To assist in developing and testing your SQL queries, Memento Database offers the [**SQL Explorer**](https://help.mementodatabase.com/?ht_kb=sql-explorer) feature. This tool provides a user-friendly interface for executing queries, viewing results directly within the app, and even leveraging AI-generated suggestions to enhance your queries.

#### sql(query)
The sql() function provides an interface for executing SELECT SQL queries within Memento Database's JavaScript environment. 

**Argument**
; query: A string containing the SQL SELECT query to be executed

**Result** — [***SQL*** object](#Object SQL)
...
For information on table and column naming conventions, as well as how to work with linked records, please refer to the 
[**SQL Explorer documentation**](https://help.mementodatabase.com/?ht_kb=sql-explorer)
...
### Http examples
See **[Trigger Examples#Http examples](Trigger_Examples.md#Http_examples)**.
...
#### email()
Returns the system Email object. Methods of the Email object may be used to send email messages, among other things. See the [***Email*** object](#Object Email).
...
**Result** — [***Intent*** object](#Object Intent) &mdash; Information exchange object
...
**Result** — [***Dialog*** object](#Object Dialog)

#### system()
Obtain information about the system
**Result** — [***System*** object](#Object System)
...
**view(ui object)** — Sets a custom view for the dialog. Accepts a [UI object](Memento_JavaScript_UI.md) that represents the custom view to be displayed within the dialog.
...
**id(int)** — Sets the ID of the notification. This is optional but useful if you need to manage or update the notification later. If a notification with the same ID already exists, it will be replaced with the new one.
**title(string)** — Sets the title of the notification. This is a mandatory field.
**text(string)** — Sets the main text of the notification. This is a mandatory field.
**bigText(string)** — Sets the expanded text that appears when the notification is expanded. This is optional.
**smallIcon(iconCode)** — Sets the small icon for the notification. This is optional and can be specified using an icon code.
**largeIcon(iconCode or imageURL)** — Sets the large icon for the notification. This is optional and can be specified using an icon code or an image URL. You can also use the value of an image field as the argument for the icon.
**alertOnce()** — Ensures that the notification alerts only once. This is optional and prevents the notification from making sound or vibrating multiple times if it is updated.
**show()** — Displays the notification. This method should be called last to show the configured notification.
...
### System examples
See **[Trigger Examples#System examples](Trigger_Examples.md#System_examples)**.
...
See **[Examples of built-in object use](Tips:Trigger_Examples.md#Examples_of_built-in_object_use)**.

---

## See also
**[Actions](Actions.md)** — Memento Actions
**[Data Sources](Data_Sources.md)** — Memento Data Sources
**[Triggers](Triggers.md)** — Memento Triggers
**[Trigger Examples](Trigger_Examples.md)** — Examples of Memento Triggers
**[Tips** — Using JavaScript in Memento](Tips**_—_Using_JavaScript_in_Memento.md): Tips for using JavaScript in Memento
