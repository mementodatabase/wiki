---
title: "How:Slice & Dice Library Data"
---
...
**Sorting** — Use sorting primarily to maintain a meaningful order of groups and of orders within groups and also to make the **No grouping** list the most useful. Sorting by numeric values can make the largest values stand out from the smallest, while grouping this way and that.
