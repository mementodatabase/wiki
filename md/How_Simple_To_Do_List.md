...
There are pages in this wiki where you can look to see all the parts of the screen you're seeing now &mdash; [Library Edit screen](Library Edit screen.md), if you feel strongly right now &mdash; but let's focus only on what we need.
...
This brings you to the [Field Edit card](Field Edit card.md); there is no need to go to that link right now, as we'll steer you where you need to go.
...
This brings you to the [Field Edit card](Field Edit card.md) again, but this time the one for a Checkbox field, so it's different.
...
Now, you'll see in the list of fields the Done? field we just defined.
      ...
      1. End by saving the library definition
...
Touch either checkbox to indicate that that task is done.
   ...
   1. End of the Simplest of To Do lists
...
- [Show only incomplete tasks](Tutorial:Simple To Do List Enhancements#Show only incomplete tasks.md)
- [Prioritize or otherwise categorize tasks](Tutorial:Simple To Do List Enhancements#Categorize tasks.md)
- [ Aggregate and chart tasks](Tutorial:Simple To Do List Enhancements#Aggregate and chart tasks.md)
