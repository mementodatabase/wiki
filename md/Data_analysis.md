...
The following sections provide an overview to the process of data analysis. If you already know what you want to do and want to see specifically how to do it in Memento, see **[How:Analyze your data](How:Analyze your data.md)**.
...
See **[How:Analyze your data](How:Analyze your data.md)** for more detailed explanation.
