...
**Sequence of numbers** — Define the range of values (from & to) and whether direct input is to be allowed in addition to value selection from a list
**Default Value** — By default, there is no default value. If a default value is specified, there are 2 other choices:
