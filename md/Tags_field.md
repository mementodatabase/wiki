...
**Name and Hint** — Standard across all field types
...
**Field name** — Display the name of the field in the card entry (By default, On).  By this, it is meant that the field name either will or will not be displayed on the Entry View card as well as on the Entry Edit card.
...
**Dependencies of the field** — Ability to add one or more visibility dependencies upon fields with qualifying types.
...
A Tags field holds a set of values. A Tag is a word, so to express multiple words as a tag, one needs to defuse a plan where spaces delineate the words, but rather some other character like an underscore (_) or hyphen (-) can indicate a division among words. This example, "black swan" could be rendered as "black_swan" or "black-swan" (without the quotes). Some might use capitalization, like "blackSwan".
   ...
   1. Properties
**Hint** — Same as in the [Mobile Edition](#Mobile_Edition.md)

**Default value** — Same as in the [Mobile Edition](#Mobile_Edition.md)

**Required** — Same as in the [Mobile Edition](#Mobile_Edition.md)

**Unique** — Selecting this option ensures that a tag entry will be unique. Can only be set in the Desktop edition.
