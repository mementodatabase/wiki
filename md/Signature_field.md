...
**Paint options** — Because the signature is captured within the application, these options describe the height & width of the paint box, the brush size & color and the background color to be used for capture & display.
