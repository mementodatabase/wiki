---
title: "Library Window menu bar"
---

The Library window menu bar has three of the same components as the Main window menu bar, [**File**](Main Window menu bar.md), [**Account**](Main Window menu bar.md) and [**Help**](Main Window menu bar.md) with these three additions:
