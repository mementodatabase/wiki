...
***[This page is incorrect, incomplete, and under development.](This page is incorrect, incomplete, and under development..md)***
...
If you're just starting with Memento or just starting to use it for something new, it may not be clear to you how to represent your data in Memento to allow the user to get what he/she wants out of it. This article suggests some approaches to consider.
   ...
   1. Structuring simply &mdash; One Main Thing
The simplest use of Memento is to use a single library to represent data about a single subject.

      1. Simple uses
For instance, you might want to have a To Do list in Memento. As is often the case, it could be anywhere from very simple to pretty complex. Let's start with the very simplest one, so see **[Tutorial:Simple To Do List](Tutorial:Simple To Do List.md)**.

Another simple use would be as a library of recipes. Could you use Memento in a very simple way to catalog your recipes and then look them up later? The easy answer is **yes**. See **[Tutorial:Simple Recipes](Tutorial:Simple Recipes.md)**.
...
If you have a set of interrelated libraries, it might make sense to add a group to contain them or perhaps to contain all libraries related to appliances or to homes.
      ...
      1. When more libraries are needed
...
#### One library per subject that contains dependent data
      1. Structuring for data analysis &mdash; slicing & dicing
   1. Structuring &mdash; Enhancing your visual presentation
      1. Fields sharing a card row
      1. Field fonts & colors
      1. List items with fonts, colors, and icons
      1. Using images
   1. Structuring &mdash; Leveraging the Internet
      1. Using Autofill
      1. Using barcodes
---
---
