...
**Result** — [***Library*** object](#Object Library.md) &mdash; the library identified by the argument *id*, if found. Otherwise *null*.
...
****Result**** — :: [***Entry*** object](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object])(#Object entry.md) &mdash; the new entry to create in the library
...
****Result**** — ::If no entries are present, then null
Otherwise, the [**Entry** object](#Object Entry.md)
...
See **[Trigger Examples#Libraries examples](Trigger Examples#Libraries examples.md)**.
...
**Result** — : [***File*** object](#Object File.md)
...
**length** — The length, in bytes, of the file, or 0L if the file does not exist. 
      ...
      1. Files examples
See **[Trigger Examples#Files examples](Trigger Examples#Files examples.md)**.
...
**Result** — [***SQL*** object](#Object SQL.md)
...
; tag: ???
      ...
      1. Http examples
See **[Trigger Examples#Http examples](Trigger Examples#Http examples.md)**.
...
**Result** — [***Dialog*** object](#Object Dialog.md)
...
Send a message
      ...
      1. System examples
See **[Trigger Examples#System examples](Trigger Examples#System examples.md)**.
...
See **[Examples of built-in object use](Tips:Trigger Examples#Examples of built-in object use.md)**.

---

   1. See also
**[Actions](Actions.md)** — Memento Actions
**[Data Sources](Data Sources.md)** — Memento Data Sources
**[Triggers](Triggers.md)** — Memento Triggers
**[Trigger Examples](Trigger Examples.md)** — Examples of Memento Triggers
**[Tips** — Using JavaScript in Memento](Tips** — Using JavaScript in Memento.md): Tips for using JavaScript in Memento
