---
title: "JGC: Bill's JavaScript Guide Companion home"
---

1. The Mozilla Developer Network (MDN)
JavaScript Guide Companion
*Bill Crews, Feb 2021*
...
1. Prevent code snippets executed in the console from interacting with one-another (e.g., having something created in one console execution being used for a different console execution).
