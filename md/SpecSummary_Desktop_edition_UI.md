---
title: "SpecSummary:Desktop edition UI"
---

1. The Desktop edition User interface
This page discusses the [Desktop edition UI (User Interface)](SpecSummary:Desktop UI.md).
For discussion of the Mobile edition user interface, read [The Mobile edition User interface](SpecSummary:Mobile UI.md)
