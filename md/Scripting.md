...
Scripting for the Calculation field type is described in the **[Calculation field](Calculation field.md) type**.
Similar scripting is also available in 2 of the 3 options in the **[Button field](Button field.md) type**.

   1. Scripting Memento in JavaScript
Scripting in JavaScript is available in **[JavaScript field](JavaScript field.md)** and **[Triggers](Triggers.md)**.
...
**Limited&nbsp;&nbsp;&nbsp;&nbsp;// *The capped amount*** — value = field("Value"); if (value <= StandardLimit) value else StandardLimit
      ...
      1. JavaScript scripting for [**Memento Triggers**](Triggers.md)
**[TBD](TBD.md)**
...
**[TBD](http://momentjs.com](https://momentjs.com))(TBD.md)**
